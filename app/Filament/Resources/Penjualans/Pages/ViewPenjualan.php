        ...
        return [
            ...
            Action::make('approve')
                ...
                ->action(function () use ($record, $user) {
                    ...
                    try {
                        ...
                        foreach ($record->items as $item) {
                            $inventoryMutationService->decrement(
                                ...
                                [
                                    ...
                                    'transaction_nomor' => $record->nomor,
                                ]
                            );
                        }
                        ...
                        InvoiceEmailService::sendApprovedNotification($record, 'penjualan');
            ...
            Action::make('markAsPaid')
                ...
                ->action(function () use ($record, $user) {
                    ...
                    try {
                        app(SaleCashSettlementService::class)->settleRemainingWithCash($record, $user);
                    ...
                    Notification::make()->title('Penjualan ditandai LUNAS dengan pembayaran cash.')->success()->send();
                }),
            ...
            // ===== DELETE =====
            DeleteAction::make()->visible(fn (): bool => $user->isSuperAdmin() && TransactionDeleteGuard::canDeletePenjualan($record)),
        ];
    }
}
