...
@endphp
<table>
    <thead><tr><th>No</th><th>Nomor</th><th>Tanggal</th><th>Gudang</th><th>Pembuat</th><th>Approver</th><th>Staf Penyetuju</th><th>Email Penyetuju</th><th>Urgensi</th><th>Tahun Anggaran</th><th>Syarat Pembayaran</th><th>Tgl Jatuh Tempo</th><th>Tag</th><th>Memo</th><th>Produk</th><th style="mso-number-format:'\@'">Kode Item</th><th>Deskripsi</th><th>Qty</th><th>Unit</th><th>Harga Satuan</th><th>Diskon</th><th>Subtotal Item</th><th>Diskon Akhir</th><th>Pajak %</th><th>Grand Total</th><th>Status</th><th>Dibuat</th></tr></thead>
    <tbody>
