...
class ApiDocController extends Controller
{
    ...
    private function buildApiSpec(): array
    {
        return [
            ...
            'tags' => [
                ...
                ['name' => 'Ringkasan Bisnis', 'description' => 'Business summary reports'],
    ...
    private function buildPaths(): array
    {
        ...
        return [
            ...
            '/ringkasan-bisnis' => ['get' => $operation('Ringkasan Bisnis', 'Ambil laporan ringkasan bisnis', 'getRingkasanBisnis', ['200' => $response('Laporan ringkasan bisnis.', $success)])],
            '/ringkasan-bisnis/export-pdf' => ['get' => $operation('Ringkasan Bisnis', 'Export ringkasan bisnis PDF', 'exportRingkasanBisnisPdf', $file)],
            '/ringkasan-bisnis/export-excel' => ['get' => $operation('Ringkasan Bisnis', 'Export ringkasan bisnis Excel', 'exportRingkasanBisnisExcel', $file)],
