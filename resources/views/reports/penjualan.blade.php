...
<table>
    <thead>
        <tr>
            <th>No</th><th>Nomor</th><th>Tanggal</th><th>Pelanggan</th><th style="mso-number-format:'\@'">No Telepon</th><th>Sales</th><th>Approver</th><th>Gudang</th><th>Tipe Harga</th><th>Syarat Pembayaran</th><th>Tgl Jatuh Tempo</th><th>Referensi</th><th>Memo</th><th>Produk</th><th>Kode Item</th><th>Deskripsi</th><th>Qty</th><th>Unit</th><th>Harga Satuan</th><th>Diskon %</th><th>Diskon Nominal</th><th>Subtotal Item</th><th>Batch</th><th>Expired</th><th>Diskon Akhir</th><th>Pajak %</th><th>Grand Total</th><th>Status</th><th>Dibuat</th>
        </tr>
    </thead>
    <tbody>
    ...
    <tfoot><tr><td colspan="26"><strong>TOTAL GRAND TOTAL</strong></td><td><strong>{{ format_rupiah($transactions->sum('grand_total')) }}</strong></td><td colspan="2"></td></tr><tr><td colspan="29" style="text-align:right; font-size:11px; color:gray;">Dibuat oleh: {{ $generatedBy ?? 'System' }} | {{ $generatedAt ?? now()->format('d/m/Y H:i') }}</td></tr></tfoot>
</table>
